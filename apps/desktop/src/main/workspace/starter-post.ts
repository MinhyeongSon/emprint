...
import { draftFlagFromRelativePath, type AppLocale, type PostSummary, type WorkspaceConfig } from '@emprint/shared'

/**
 * Starter post creation lives next to the bootstrapper because it is the only
 * piece of "first markdown" content emprint emits for Column workspaces.
 */
