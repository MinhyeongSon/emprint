...
/** Column-only package.json tweaks: Pagefind devDependency + post-build index step. */
export function columnPackageJsonPatch(artifacts: WorkspaceArtifact[]): WorkspaceArtifact[] {
